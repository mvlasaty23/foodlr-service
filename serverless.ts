...
const serverlessConfiguration: AWS = {
  ...
  custom: {
    ...
    menuplan_table: '${self:service}-menuplan-table-${opt:stage, self:provider.stage}',
  ...
  provider: {
    ...
    environment: {
      ...
      MENUPLAN_TABLE: '${self:custom.menuplan_table}',
      ...
      role: {
        statements: [
          ...
          },
          {
            ...
            Resource: [{ 'Fn::GetAtt': ['MenuplanTable', 'Arn'] }],
          },
        ],
      },
    },
